...
async def get_buying_list(message):
    await message.answer('Название: Product1 | Описание: 1 | Цена: 100')
    with open('1_orange.png', 'rb') as img:
        await message.answer_photo(img)

    await message.answer('Название: Product2 | Описание: 2 | Цена: 100')
    with open('2_carrot.png', 'rb') as img:
        await message.answer_photo(img)

    await message.answer('Название: Product3 | Описание: 3 | Цена: 500')
    with open('3_multivitamins.png', 'rb') as img:
        await message.answer_photo(img)

    await message.answer('Название: Product4 | Описание: 4 | Цена: 10')
    with open('4_enema.png', 'rb') as img:
        await message.answer_photo(img)
